...
Bu lab çalışmasında, opsfv2 auhtnetication inceleyeceğiz.
...
Standart bir OSPF yapılandırılmasında hello paketlerinde Auth Type null olarak gider.

<img width="540" height="362" alt="image" src="https://github.com/user-attachments/assets/2de143ae-eed7-4709-b930-6731d3a921b0" />

Basit şifreleme yöntemi olan plain-text yöntemi ile şifrelendiğinde bir kimlik doğrulama sağlar ancak parola hello paketi içinde şifrelenmeden(encrypt) gönderilir. 
...
R3 authentication olmadan yapılandırıldığında hello paketi gönderdiği ve aldığı halde komşuluk kuramamaktadır.
<img width="836" height="60" alt="image" src="https://github.com/user-attachments/assets/62f9e8be-d5eb-4262-bd0a-ccf7fbc9713b" />


Aynı  şekilde R3 te de parola girildiğinde ospf komşuluğu kurulmaktadır.
...
Yukarıda da bahsettiğim gibi bu yöntem ile paroala şifrelenmeden gönderidiğinden basit bir güvenlik sağlamaktadır. Bunun yerine MD5 ile parola şifrelenerek gönderildiğinde paketler dinlenilse dahi parola tespit edilemiyecektir.
...
### NOT
Authentication bir kimlik doğrulama olduğu için, giden paketlerde datayı şifrelemez. Yami LS update paketlerinde gönderilen networkler tespit edilebilir. Ancak burada yapılan koruma, sahte router'ın ospf komşuluğu kurarak ağa sahte rotalar enjekte etmesini engellemektir.
