...
### Özellikler
- Point to point sana tünel oluşturur
...
- IP paketlerini GRE header ve yeni bir dış IP header eklenir.
...
Router'a geldiğinde ise tünelden geçerek IP header üzerine  Gre header ve tünnel source ve destination IP header eklenmektedir.
